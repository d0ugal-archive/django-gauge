...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BenchmarkSuite.show_on_dashboard'
        db.add_column('gauge_benchmarksuite', 'show_on_dashboard', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BenchmarkSuite.show_on_dashboard'
        db.delete_column('gauge_benchmarksuite', 'show_on_dashboard')
